...
(cl:defmethod cl:initialize-instance :after ((m <SetMission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name itm_mav_msgs-msg:<SetMission> is deprecated: use itm_mav_msgs-msg:SetMission instead.")))
...
(cl:defmethod command_idx-val ((m <SetMission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader itm_mav_msgs-msg:command_idx-val is deprecated.  Use itm_mav_msgs-msg:command_idx instead.")
  (command_idx m))

(cl:ensure-generic-function 'mission_mode-val :lambda-list '(m))
(cl:defmethod mission_mode-val ((m <SetMission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader itm_mav_msgs-msg:mission_mode-val is deprecated.  Use itm_mav_msgs-msg:mission_mode instead.")
  (mission_mode m))
