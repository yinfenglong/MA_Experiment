...
"""autogenerated by genpy from itm_mav_msgs/itm_trajectory_msg.msg. Do not edit."""
import codecs
import sys
...
class itm_trajectory_msg(genpy.Message):
  _md5sum = "d9bcd1f60582328c13383ece94b6ed5c"
  _type = "itm_mav_msgs/itm_trajectory_msg"
...
"""
  __slots__ = ['header','size','traj','data']
  _slot_types = ['std_msgs/Header','uint32','itm_mav_msgs/itm_trajectory_point[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(itm_trajectory_msg, self).__init__(*args, **kwds)
