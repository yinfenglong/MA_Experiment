// Generated by gencpp from file itm_nonlinear_mpc/itm_kf_observer.msg
// DO NOT EDIT!


#ifndef ITM_NONLINEAR_MPC_MESSAGE_ITM_KF_OBSERVER_H
#define ITM_NONLINEAR_MPC_MESSAGE_ITM_KF_OBSERVER_H
...
struct itm_kf_observer_
{
  typedef itm_kf_observer_<ContainerAllocator> Type;
  ...
  itm_kf_observer_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , position()
    , velocity()
    , attitude()
  ...
  typedef boost::shared_ptr< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> const> ConstPtr;

}; // struct itm_kf_observer_

typedef ::itm_nonlinear_mpc::itm_kf_observer_<std::allocator<void> > itm_kf_observer;

typedef boost::shared_ptr< ::itm_nonlinear_mpc::itm_kf_observer > itm_kf_observerPtr;
typedef boost::shared_ptr< ::itm_nonlinear_mpc::itm_kf_observer const> itm_kf_observerConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator1> & lhs, const ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
{
  ...
  static const char* value(const ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9ea414391f3791b9ULL;
  static const uint64_t static_value2 = 0x5995d410be8fb3abULL;
};

template<class ContainerAllocator>
struct DataType< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::itm_nonlinear_mpc::itm_kf_observer_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ITM_NONLINEAR_MPC_MESSAGE_ITM_KF_OBSERVER_H
