...
(cl:defclass <itm_trajectory_msg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (traj
    :reader traj
    :initarg :traj
    :type (cl:vector itm_nonlinear_mpc-msg:itm_trajectory_point)
   :initform (cl:make-array 0 :element-type 'itm_nonlinear_mpc-msg:itm_trajectory_point :initial-element (cl:make-instance 'itm_nonlinear_mpc-msg:itm_trajectory_point)))
   (data
    :reader data
    :initarg :data
...
(cl:defmethod cl:initialize-instance :after ((m <itm_trajectory_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'itm_trajectory_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name itm_nonlinear_mpc-msg:<itm_trajectory_msg> is deprecated: use itm_nonlinear_mpc-msg:itm_trajectory_msg instead.")))
...
(cl:defmethod size-val ((m <itm_trajectory_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader itm_nonlinear_mpc-msg:size-val is deprecated.  Use itm_nonlinear_mpc-msg:size instead.")
  (size m))

(cl:ensure-generic-function 'traj-val :lambda-list '(m))
(cl:defmethod traj-val ((m <itm_trajectory_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader itm_nonlinear_mpc-msg:traj-val is deprecated.  Use itm_nonlinear_mpc-msg:traj instead.")
  (traj m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <itm_trajectory_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader itm_nonlinear_mpc-msg:data-val is deprecated.  Use itm_nonlinear_mpc-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <itm_trajectory_msg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'traj)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'itm_nonlinear_mpc-msg:itm_trajectory_point))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<itm_trajectory_msg>)))
  ...
  "itm_nonlinear_mpc/itm_trajectory_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'itm_trajectory_msg)))
  "Returns string type for a message object of type 'itm_trajectory_msg"
  "itm_nonlinear_mpc/itm_trajectory_msg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<itm_trajectory_msg>)))
  ...
  "5fbf4a175c3bba98dd9f6a860e83cf2f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'itm_trajectory_msg)))
  "Returns md5sum for a message object of type 'itm_trajectory_msg"
  "5fbf4a175c3bba98dd9f6a860e83cf2f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<itm_trajectory_msg>)))
  ...
  (cl:format cl:nil "Header header~%uint32 size~%itm_nonlinear_mpc/itm_trajectory_point[] traj~%float64[] data~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: itm_nonlinear_mpc/itm_trajectory_point~%float64 x~%float64 y~%float64 z~%float64 vx~%float64 vy~%float64 vz~%float64 roll~%float64 pitch~%float64 yaw~%float64[4] q~%float64[2] cube_x~%float64[2] cube_y~%float64[2] cube_z~%float64[2] cube_yaw~%bool fixed~%bool time_known~%int8 derivative~%int8 segment_index~%float64 time_stamp~%bool quaternion_given~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'itm_trajectory_msg)))
  "Returns full string definition for message of type 'itm_trajectory_msg"
  (cl:format cl:nil "Header header~%uint32 size~%itm_nonlinear_mpc/itm_trajectory_point[] traj~%float64[] data~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: itm_nonlinear_mpc/itm_trajectory_point~%float64 x~%float64 y~%float64 z~%float64 vx~%float64 vy~%float64 vz~%float64 roll~%float64 pitch~%float64 yaw~%float64[4] q~%float64[2] cube_x~%float64[2] cube_y~%float64[2] cube_z~%float64[2] cube_yaw~%bool fixed~%bool time_known~%int8 derivative~%int8 segment_index~%float64 time_stamp~%bool quaternion_given~%~%~%"))
