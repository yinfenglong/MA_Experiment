...
;//! \htmlinclude itm_kf_observer.msg.html

(cl:defclass <itm_kf_observer> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass itm_kf_observer (<itm_kf_observer>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <itm_kf_observer>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'itm_kf_observer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name itm_nonlinear_mpc-msg:<itm_kf_observer> is deprecated: use itm_nonlinear_mpc-msg:itm_kf_observer instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <itm_kf_observer>))
...
(cl:defmethod position-val ((m <itm_kf_observer>))
...
(cl:defmethod velocity-val ((m <itm_kf_observer>))
...
(cl:defmethod attitude-val ((m <itm_kf_observer>))
...
(cl:defmethod angular_velocity-val ((m <itm_kf_observer>))
...
(cl:defmethod external_forces-val ((m <itm_kf_observer>))
...
(cl:defmethod external_moments-val ((m <itm_kf_observer>))
...
(cl:defmethod forces_offset-val ((m <itm_kf_observer>))
...
(cl:defmethod moments_offset-val ((m <itm_kf_observer>))
  ...
  (moments_offset m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <itm_kf_observer>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <itm_kf_observer>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<itm_kf_observer>)))
  "Returns string type for a message object of type '<itm_kf_observer>"
  "itm_nonlinear_mpc/itm_kf_observer")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'itm_kf_observer)))
  "Returns string type for a message object of type 'itm_kf_observer"
  "itm_nonlinear_mpc/itm_kf_observer")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<itm_kf_observer>)))
  "Returns md5sum for a message object of type '<itm_kf_observer>"
  "9ea414391f3791b95995d410be8fb3ab")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'itm_kf_observer)))
  "Returns md5sum for a message object of type 'itm_kf_observer"
  "9ea414391f3791b95995d410be8fb3ab")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<itm_kf_observer>)))
  "Returns full string definition for message of type '<itm_kf_observer>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'itm_kf_observer)))
  "Returns full string definition for message of type 'itm_kf_observer"
  (cl:format cl:nil "Header header~%float64[3] position~%float64[3] velocity~%float64[3] attitude~%float64[3] angular_velocity~%float64[3] external_forces~%float64[3] external_moments~%float64[3] forces_offset~%float64[3] moments_offset~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <itm_kf_observer>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <itm_kf_observer>))
  "Converts a ROS message object to a list"
  (cl:list 'itm_kf_observer
