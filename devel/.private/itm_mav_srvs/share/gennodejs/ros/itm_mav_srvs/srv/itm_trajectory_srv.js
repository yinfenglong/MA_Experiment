...
let itm_mav_msgs = _finder('itm_mav_msgs');
...
class itm_trajectory_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.traj.forEach((val) => {
      bufferOffset = itm_mav_msgs.msg.itm_trajectory_point.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.traj[i] = itm_mav_msgs.msg.itm_trajectory_point.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.traj !== undefined) {
      ...
      for (let i = 0; i < resolved.traj.length; ++i) {
        resolved.traj[i] = itm_mav_msgs.msg.itm_trajectory_point.Resolve(msg.traj[i]);
      }
    }
    else {
      resolved.traj = []
...
module.exports = {
  ...
  md5sum() { return 'bf0f076326f268117df02baf1b905ccb'; },
  datatype() { return 'itm_mav_srvs/itm_trajectory_srv'; }
};
