...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name itm_mav_srvs-srv:<SetMode-request> is deprecated: use itm_mav_srvs-srv:SetMode-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <SetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader itm_mav_srvs-srv:mode-val is deprecated.  Use itm_mav_srvs-srv:mode instead.")
  (mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name itm_mav_srvs-srv:<SetMode-response> is deprecated: use itm_mav_srvs-srv:SetMode-response instead.")))
