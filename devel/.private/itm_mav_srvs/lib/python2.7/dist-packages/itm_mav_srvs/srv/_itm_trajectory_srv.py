...
"""autogenerated by genpy from itm_mav_srvs/itm_trajectory_srvRequest.msg. Do not edit."""
import codecs
import sys
...
import itm_mav_msgs.msg

class itm_trajectory_srvRequest(genpy.Message):
  _md5sum = "69726911c754491de400bbe2477ac599"
  _type = "itm_mav_srvs/itm_trajectory_srvRequest"
...
"""
  ...
  _slot_types = ['uint32','itm_mav_msgs/itm_trajectory_point[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = itm_mav_msgs.msg.itm_trajectory_point()
        _x = val1
        start = end
        end += 129
        ...
        val1.input_given = bool(val1.input_given)
        start = end
        end += 32
...
def _get_struct_4d():
    ...
    return _struct_4d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from itm_mav_srvs/itm_trajectory_srvResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class itm_trajectory_srvResponse(genpy.Message):
  ...
  _type = "itm_mav_srvs/itm_trajectory_srvResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class itm_trajectory_srv(object):
  _type          = 'itm_mav_srvs/itm_trajectory_srv'
  _md5sum = 'bf0f076326f268117df02baf1b905ccb'
