 ...
 * @LastEditors: Wei Luo
 * @LastEditTime: 2021-08-21 17:34:55
 * @Note: Note
 */
#include <itm_nonlinear_mpc/controller/mpc_acados/mpc_q_acados_safetakeoff.hpp>
namespace acados_quadrotor
{
    ...
    void MPCAcadosController::safe_takeoff()
    {
        ...
        msg.position.z = takeoff_height_;
        ...
        {
            // boost::shared_lock<boost::shared_mutex> mpc_lk(mutexMPCCallback_);
            // std::cout << "thrust pid" << control_acc_offset << std::endl;

            // std::cout << "thrust prepared" << robot_command[3] / 9.8066 * control_acc_offset << std::endl;
        }
    }
    ...
    bool
    MPCAcadosController::controller_server_response_callback(itm_mav_srvs::GetControllerState::Request &req,
