#ifndef SI_CONTROLLER_HPP
#define SI_CONTROLLER_HPP
/*
 * @Author: Wei Luo
 * @Date: 2021-03-22 14:05:09
 * @LastEditors: Wei Luo
 * @LastEditTime: 2021-06-06 22:56:15
 * @Note: Note
 */
...
{
public:
    SIController(const ros::NodeHandle &nh, const ros::NodeHandle &private_nh);
    ~SIController();
    void landing();
    void takeoff_target();
    void mission_loop();
...
private:
    ...
    ros::Publisher command_angle_target_pub_;
