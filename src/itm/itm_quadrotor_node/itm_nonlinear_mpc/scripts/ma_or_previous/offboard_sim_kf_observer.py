...
LastEditors: Wei Luo
LastEditTime: 2020-11-12 11:48:41
Note: Note
'''
...
class KF_observer(object):
    ...
    def initialize(self, sampling_time):
        ...
        self.drag_coefficients_matrix = np.diag([0.01, 0.01, 0.0])
    ...
    def feedAttitudeCommand(self, command):
        ...
        # print(self.roll_pitch_yaw_thrust_cmd)


    def updateEstimator(self,):
        if not self.initialized:
            return False
        rospy.loginfo_once("KF is updated for first time.")
