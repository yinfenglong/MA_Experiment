...
out[1] = xd[4];
out[2] = xd[5];
out[3] = ((((((a[0]*a[1])*a[2])+(a[3]*a[4]))*u[2])-a[10])+od[0]);
out[4] = ((((((a[11]*a[12])*a[13])-(a[14]*a[15]))*u[2])-a[28])+od[1]);
out[5] = (((real_t)(-9.8065999999999995e+00)+((a[29]*a[30])*u[2]))+od[2]);
out[6] = ((((real_t)(7.5000000000000000e-01)*u[0])-xd[6])/(real_t)(2.5700000000000001e-01));
out[7] = ((((real_t)(7.8000000000000003e-01)*u[1])-xd[7])/(real_t)(2.5900000000000001e-01));
...
a[70] = (cos(xd[6]));
a[71] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.5700000000000001e-01));
a[72] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.5700000000000001e-01));
a[73] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.5900000000000001e-01));
a[74] = ((real_t)(1.0000000000000000e+00)/(real_t)(2.5900000000000001e-01));
...
out[81] = ((real_t)(7.5000000000000000e-01)*a[72]);
...
out[94] = ((real_t)(7.8000000000000003e-01)*a[74]);
